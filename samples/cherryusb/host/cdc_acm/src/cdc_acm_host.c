...
static void usbh_cdc_acm_tx_thread(void *p1, void *p2, void *p3)
{
    int ret;
    struct usbh_cdc_acm *cdc_acm_class = (struct usbh_cdc_acm *)p1;
...
static void usbh_cdc_acm_rx_thread(void *p1, void *p2, void *p3)
{
    int ret;
    struct usbh_cdc_acm *cdc_acm_class = (struct usbh_cdc_acm *)p1;
